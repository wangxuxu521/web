...
public class CodeGeneration {
    ...
    public static void Generation(String databaseName,String... tableName){
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/dbks?serverTimezone=UTC&characterEncoding=utf-8","root","tfzz5255")
                ...
                .packageConfig(builder -> {
                    builder.entity("entity")//实体类包名
                            .parent("com.example.web")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
